...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/api/customer/email/*").permitAll()//.hasAnyRole("USER", "ADMIN")
//                .antMatchers(HttpMethod.GET, "/api/customer/email/*").permitAll()//
                .antMatchers(HttpMethod.POST, "/api/customer").permitAll()//.hasAnyRole("USER", "ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/customer/*").permitAll()//.hasAnyRole("USER", "ADMIN")
                .antMatchers(HttpMethod.DELETE, "/api/customer/*").permitAll()//.hasAnyRole("USER", "ADMIN")

                .antMatchers(HttpMethod.GET,  "/api/order/*", "/api/order").permitAll()//.permitAll()
...
//                .antMatchers(HttpMethod.GET, "/api/order/customer/*").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/mask/admin").hasRole("ADMIN")
